            ...
            if chat_member.restricted_by.id == (client.get_me()).id:
                try:
                    ...
                    client.answer_callback_query(
                        cb.id,
                        text=f"❗ Bergabunglah dengan saluran @{channel} kami dan tekan tombol 'UnMute Me' lagi.",
                        show_alert=True,
                    )
            else:
                client.answer_callback_query(
                    cb.id,
                    text="❗ Anda telah dibungkam oleh Admin karena alasan lain.",
                    show_alert=True,
                )
        else:
            if (
                ...
                client.answer_callback_query(
                    cb.id,
                    text="❗Peringatan: Jangan mengklik tombol saat Anda dapat berbicara.",
                    show_alert=True,
                )
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "Halo{} 🙏 \n \nAnda belum bergabung dengan Saluran @{} kami 😭 \ nSilakan bergabung dan sentuh Tombol BATALKAN ULANG SAYA di bawah \n \n **[👉 OUR CHANNEL 👈](https://t.me/{})**".format(
                    ...
                    sent_message.edit(
                        "❗ Saya bukan Admin ini .. \n__Beri saya Admin dengan Izin Blokir dan coba lagi .. \n # Mengakhiri FSub...__"
                    )

            except ChatAdminRequired:
                client.send_message(
                    chat_id,
                    text=f"❗ **Saya bukan admin dari @{channel}.. ** \n__Beri saya admin dan tambahkan lagi. \n #Meninggalkan chat ini...__",
                )
