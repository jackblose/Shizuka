...
from AstrakoBot import dispatcher, WHITELIST_USERS, TIGER_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID, SUPPORT_CHAT
from AstrakoBot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
...
disasters = """ AstrakoBot has bot access levels we call as *"Disaster Levels"*
...
Owner has complete bot access, including bot adminship in chats AstrakoBot is at.
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in AstrakoBot.
\n*Demons* - Have access go globally ban users across AstrakoBot.
